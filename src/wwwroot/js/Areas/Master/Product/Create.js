$(function () {
    ...
    matTypeVM = {
        ...
        init: function () {
            ...
            dtMatType = $('#tblMatType').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    "url": $('#CreateData').data('mattype-get-url'),
                    "type": "GET",
                    "datatype": "json"
                },
                columns: [
    ...
    mcVM = {
        dtMc: null,
        init: function () {
            var url = $('#CreateData').data('mc-get-url') + "/" + $('#ProductionType').val();
    ...
    prodProcessVM = {
        dtProdprocess: null,
        init: function () {
            var url = $('#CreateData').data('proc-get-url') + "/0";
    ...
    $("#tblProdProcess").on("click", "td input[type=checkbox]", function (event) {
