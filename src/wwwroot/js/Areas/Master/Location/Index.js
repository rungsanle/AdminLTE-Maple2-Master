$(function () {
    ...
    locationVM = {
        ...
        init: function () {
            dtLoc = $('#tblLocation').DataTable({
                ...
                ajax: {
                    ...
                    error: function (xhr, txtStatus, errThrown) {
                        ...
                        toastr.error('Error: ' + reponseErr.message, 'Get Location Error', { timeOut: appSetting.toastrErrorTimeout, extendedTimeOut: appSetting.toastrExtenTimeout });
                    }
                },
                columns: [
            ...
            dtLoc.on('order', function () {
                if (dtLoc.page() !== page) {
                    dtLoc.page(page).draw('page');
                }
            });

            dtLoc.on('page', function () {
                page = dtLoc.page();
            });
